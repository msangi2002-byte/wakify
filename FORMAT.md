...
## 🗄️ 2. Database Sync (`database.sql`)
Whenever you create or edit a **Model**, you must immediately update or create the `database.sql` file in the root directory.
